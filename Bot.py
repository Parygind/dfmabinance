                    ...
                    if symb not in dict_order and symb not in dict_pass and symb != 'BTCBUSD':
                        ...
                        for i, e in reversed(list(enumerate(dict_list[symb]))):
                            if (t - e[0]) / 1000 <= 30:
                                ...
                                if step == 2:
                                    if prevVol >= dict_curr[symb] * (0.015 * (30/60)) and price / e[2] < 1.01:
                                        ...
                                        if max(max_price, price) / min_price < 1.03:
                                ...
                                if step == 3:
                                    if prevVol >= dict_curr[symb] * (0.015 * (45/60)) and price / e[2] < 1.01:
                                        inf = get_klines1(symb, '1m', None, 5)
                                        min_price = 999
                                        max_price = 0
