...
def print_stream_data_from_stream_buffer(binance_websocket_api_manager):
    global profit, sl, tk, trade_on, order_price, start_time
    while True:
                    ...
                    if symb in dict_order and dict_order[symb][0] < t and not data['m']:
                        ...
                        if price < dict_trail[symb]:
                            ...
                            if (t - dict_order[symb][0]) / 1000 > 300:
                                if price >= dict_order[symb][1] and dict_trail[symb] < dict_order[symb][1]:
                                    profit += (price / (dict_order[symb][1] * 1.0015) - 1)
                                    tk += 1
                                    dict_pass[symb] = t
                                    if trade_on:
                        ...
                        for i, e in reversed(list(enumerate(dict_list[symb]))):
                            ...
                            if (t - e[0]) / 1000 < 60:
                                ...
                                if price_open_4 < price_open_5:
                                    ...
                                    if prevVol > dict_curr[symb] * 0.001 and prevVol < dict_curr[symb] * 0.02 and price / price_open_5 < 1.01 and price / price_open_5 > 1.002: #and price5 < price4 and price4 < price3 and price3 < price2 and price2 < price1 and price1 < price:
                            ...
                            if 1 == 2:
                                ...
                                if (t - e[0]) / 1000 <= 30:
                                    ...
                                    if step == 2:
                                        if prevVol >= dict_curr[symb] * (0.019 * (30/60)) and price / e[2] < 1.01 and price / e[2] > 1.0015:
                                            ...
                                            old_vol = 0
                                            old_vol_2 = 0
                                            for ii, ee in reversed(list(enumerate(dict_list[symb]))):
                                                pp = float(ee[2])
                                            ...
                                            if max(max_price, price) / min_price < 1.02 and price / old_price >= 0.98 and old_vol > 0 and old_vol_2 > 0:
                                    ...
                                    if step == 3:
                                        if prevVol >= dict_curr[symb] * (0.019 * (45/60)) and price / e[2] < 1.01 and price / e[2] > 1.0015:
                                            #inf = get_klines1(symb, '1m', None, 5)
                                            min_price = 999
                                            max_price = 0
                                    ...
                                    if prevVol >= dict_curr[symb] * 0.019 and price / e[2] < 1.01 and price / e[2] > 1.0015:
