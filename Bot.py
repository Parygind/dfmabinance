                        ...
                        for i, e in reversed(list(enumerate(dict_list[symb]))):
                            ...
                            if (t - e[0]) / 1000 < 60:
                                ...
                                if price4 < price5:
                                    ...
                                    if prevVol > dict_curr[symb] * 0.003 and prevVol < dict_curr[symb] * 0.02 and price / price5 < 1.01: #and price5 < price4 and price4 < price3 and price3 < price2 and price2 < price1 and price1 < price:
