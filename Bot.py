                    ...
                    if symb not in dict_order and symb not in dict_pass and symb != 'BTCBUSD':
                        ...
                        for i, e in reversed(list(enumerate(dict_list[symb]))):
                            if (t - e[0]) / 1000 <= 30:
                                ...
                                if step == 2:
                                    if prevVol >= dict_curr[symb] * (0.015 * (30/60)) and price / dict_list[symb][0][2] > 1.005:
                                ...
                                if step == 3:
                                    if prevVol >= dict_curr[symb] * (0.015 * (45/60))  and price / dict_list[symb][0][2] > 1.005:
                                        inf = get_klines1(symb, '1m', int((time.time() - 300) * 1000), 5)
                                        min_price = 999
                                        max_price = 0
                                ...
                                if prevVol >= dict_curr[symb] * 0.015 and price / dict_list[symb][0][2] > 1.005:
                                    inf = get_klines1(symb, '1m', int((time.time() - 300) * 1000), 5)
                                    min_price = 999
                                    max_price = 0
